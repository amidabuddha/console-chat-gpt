...
from console_gpt.config_manager import (check_valid_config, fetch_variable,
                                        write_to_config)
...
def console_gpt() -> None:
    ...
    while True:
        ...
        # Inner Loop
        while True:
            if fetch_variable("structure", "valid", auto_exit=False) == 0:
                help_message()
                write_to_config("structure", "valid", new_value=1)
